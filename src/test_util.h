...
/* ATTENTION: at your discretion, you may use this file as if instead of the
 * above license disclaimer, the following text was present:
 *
 *-----------------------------------------------------------------------------
 * Copyright 2020 Charles Daniels
 *
 ...
 *-----------------------------------------------------------------------------
 *
 * You might wish to do this if the Unlicense violates author's moral rights or
 * is otherwise invalid in your jurisdiction.
 */
